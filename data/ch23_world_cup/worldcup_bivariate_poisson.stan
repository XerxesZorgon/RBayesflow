functions {
  real bivariate_poisson_log_lpmf_(int score1, int score2, real log_lambda_1,
                                    real log_lambda_2, real log_lambda_3) {
    ...
    return -exp(log_lambda_1) - exp(log_lambda_2) - exp(log_lambda_3)
           + log_sum_exp(log_terms);
  }
  real bivariate_poisson_log_lpmf(array[,] int score, vector log_lambda_1,
                                   vector log_lambda_2, real log_lambda_3) {
  ...
  real bivariate_poisson_log_lpmf(array[] int score, real log_lambda_1,
                                   real log_lambda_2, real log_lambda_3) {
