// Model 7: proportional errors with distance_tolerance as parameter
// overshot fixed at 1 (passed as data)
data {
  int J;
  array[J] int n;
  vector[J] x;
...
model {
  ...
  // log-normal prior for distance_tolerance: mean log(3), sd 0.2
